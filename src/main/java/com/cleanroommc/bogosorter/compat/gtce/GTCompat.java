...
public class GTCompat {
    ...
    public static boolean isGTCEu(ModContainer m) {
        return "GregTech".equals(m.getMetadata().name);
    }

    public static boolean isGTCE(ModContainer m) {
        return "GregTech Community Edition".equals(m.getMetadata().name);
    }

    public static boolean isGTNE(ModContainer m) {
        return "GregTech Nomifactory Edition".equals(m.getMetadata().name);
    }
}
